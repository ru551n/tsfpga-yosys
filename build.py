...
from common import HDL_MODULES_MODULES_PATH, HDL_MODULES_PATH, MODULES_PATH, TSFPGA_PATH, REPO_ROOT
...
from tsfpga.module import get_module, get_modules


def main() -> None:

    modules = get_modules(MODULES_PATH)
    modules += get_modules(HDL_MODULES_MODULES_PATH)

    args = arguments(REPO_ROOT / "out")
